 ...
 *
 */
package net.mcreator.pokeystfmod;
...
@Mod("pokeys_tf_mod")
public class PokeysTfModMod {
	public static final Logger LOGGER = LogManager.getLogger(PokeysTfModMod.class);
	public static final String MODID = "pokeys_tf_mod";

	public PokeysTfModMod() {
